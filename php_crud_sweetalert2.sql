...
--
-- Host: localhost
-- Generation Time: Oct 26, 2020 at 03:48 PM
...
ALTER TABLE `tbl_customers`
  MODIFY `c_id` int
(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีลูกค้า', AUTO_INCREMENT=3;
...
ALTER TABLE `tbl_products`
  MODIFY `p_id` int
(11) NOT NULL AUTO_INCREMENT COMMENT 'ไอดีสินค้า', AUTO_INCREMENT=104;
COMMIT;
